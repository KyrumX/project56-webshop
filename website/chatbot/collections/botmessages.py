...
NOT_FOUND = "Ik heb uw vraag niet goed begrepen. Probeer vooral steekwoorden te gebruiken."
...
RETURN_RESPONSE = "Bent u niet tevreden met een product? Voldoet het product niet aan uw verwachtingen?" \
                  ...
                  " mits dit gebeurt binnen de eerste 14 dagen na het ontvangen van uw bestelling." \
                  " Bij het pakketje dat u heeft ontvangen van onze pakketbezorger zit een formulier voor het" \
                  " retourneren. Let bij het invullen en van dit formulier goed op of u wilt 'Retourner' of dat" \
                  " u het gekregen product wilt 'Ruilen'. Heeft u meerdere dingen ontvangen in uw bestelling en wilt u" \
                  " ze niet allemaal retourneren? Markeer dan alleen de producten die u wilt retourneren op het" \
                  " formulier. Bij het terugsturen moet u de producten goed verpakken om schade te voorkomen en" \
